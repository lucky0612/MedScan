...
def predict_segmentation(img_path, model, threshold=0.5):
    im_width = 256
    im_height = 256
...
model = load_model('/Users/laravi/Downloads/healthcare/BT_Model.hdf5')
...
if uploaded_file is not None:
    with st.spinner('Processing...'):
        x_img, binary_predictions = predict_segmentation(uploaded_file, model)
